      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 md:gap-x-16 items-center">
          ...
          >
            ...
            >
              We're a passionate team of innovators, strategists, and creators
              dedicated to transforming your challenges into impactful
              solutions. Discover how our blend of expertise and creativity can
