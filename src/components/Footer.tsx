...
function Footer() {
  ...
  return (
    ...
    id="contact"
      ...
      className="bg-black text-footer-text-secondary pt-16 md:pt-24 pb-8 rounded-t-4xl md:rounded-t-5xl" // Large top rounding
    >
      <div className="container mx-auto px-6 sm:px-8">
        ...
        <div className="text-center text-xs pt-8 border-t border-footer-divider">
          <p>AYNA.</p>
          <p className="mt-1">
            Copyright © {new Date().getFullYear()} AYNA. All rights reserved.
          </p>
        </div>
      </div>
    </motion.footer>
